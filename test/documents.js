    ...
    helper.loginUser(helper.userTest, function(loginuser) {
      request(app)
        ...
        .end((err, res) => {
          t.ok(
            res.body.error === true,
            "/api/documents/badid is not a valid document id"
          );
          t.end(err);
        });
    });
        ...
        .end((err, res) => {
          ...
          request(app)
            ...
            .end((error, response) => {
              t.error(
                error,
                "Get document should fail witout authentification"
              );
            });
        ...
        .end((err, res) => {
          ...
          helper.createUser(helper.userTest2, function(newuser2) {
            helper.loginUser(helper.userTest2, function(loginuser2) {
              request(app)
                .get("/api/documents/" + doc._id + "/opentoken")
                ...
                .end((error, res1) => {
                  request(app)
                    ...
                    .end((error, res2) => {
                      t.ok(
                        res2.body.lastOpenedBy.username == loginuser2.username,
          ...
          request(app)
            ...
            .end((error, response) => {
              t.ok(
                ...
                `document ${doc._id} has been successfully updated`
              );
              ...
              request(app)
                ...
                .end((error2, response2) => {
                  t.same(
                    response2.body.name,
                    new_name,
                    `document name has been successfully updated`
                  );
            ...
            .end((err, res) => {
              ...
              request(app)
                ...
                .end((err, res) => {
                  ...
                  t.ok(
                    res.body.trashed == true,
                    "trashed field should be true"
                  );
                  ...
                  request(app)
                    ...
                    .end((err, res) => {
                      ...
                      request(app)
                        ...
                        .end((err, res) => {
                          t.notOk(
                            "trashedBy" in res.body,
                            "untrash removes trashedBy field"
                          );
                          t.notOk(
                            "trashedDate" in res.body,
                            "untrash removes trashedDate field"
                          );
